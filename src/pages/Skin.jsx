  ...
  return (
    <group position={position}>
      ...
      >
        ...
        <meshStandardMaterial color={active || hovered ? 'gold' : color} />
...
function Skin() {
  ...
  style={{ 
    padding: '0px 0px', 
    maxWidth: '1800px', // Smaller width makes centered text easier to read
    margin: '0 auto',
    textAlign: 'center',
...
>
	...
	{/* Larger, bolded title with a letter-spacing boost */}
  <h2 style={{ 
	...
	{/* A small decorative divider line */}
  <div style={{ 
    width: '160px', 
    height: '4px', 
    background: '#F8C8C4', 
